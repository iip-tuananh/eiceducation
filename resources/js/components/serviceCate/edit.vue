      ...
      <div class="row">
        <div class="col-12 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              <div class="row">
                <div class="col-md-3"><h4 class="card-title">Thêm mới các nước</h4></div>
              ...
              <form class="forms-sample">
                <div class="form-group">
                  <vs-input
                    ...
                    font-size="40px"
                    label-placeholder="VD: Du học Úc"
                  />
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label>Mô tả (VD hiển thị trong mục Du học Úc)</label>
                    <TinyMce v-model="objData.description" />
                </div>
                <div class="form-group">
                    <label>Nội dung giới thiệu (VD hiển thị trong mục Về nước Úc)</label>
...
export default {
  ...
  methods: {
    ...
    saveEdit() {
      ...
      if(this.objData.description == '') this.errors.push('Mô tả không để trống');
      if(this.objData.content == '') this.errors.push('Giới thiệu không để trống');
